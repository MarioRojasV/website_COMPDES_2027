...
export const ui = {
  es: {
    ...
    "cron.filter.tabsAria": "Filtrar la agenda de ponencias por día",
    "cron.filter.all": "Todos",
    "cron.filter.allSub": "21–23 jul",
  ...
  en: {
    ...
    "cron.filter.tabsAria": "Filter the talk agenda by day",
    "cron.filter.all": "All days",
    "cron.filter.allSub": "Jul 21–23",
